    ...
    var ChoosedClient;
     ...
     var baseUrl = "https://internal.ey.net/sites/SPF/_api/web";
      ...
      id = success.d.Id;
         ...
         var select = '';
            var select = '<select class="custom-select rm-sm-4" id="PartnerName">';
...
var ChoosedClient = $('#myInput').val();
XHRrequest(baseUrl + "/lists/getbytitle('Clients')/items?$filter=Title eq '" + $('#myInput').val() + "'", function(success) {
       console.log(success);
    //SelectedClientID = success.d.results[0].Column2;
    //SelectedClientName = success.d.results[0].Title;
    
    //console.log("Selected :" + SelectedClientID);
    //console.log("Selected :" + SelectedClientName);
